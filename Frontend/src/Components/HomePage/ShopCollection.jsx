...
function ShopCollection () {
    ...
    return (
        <div className="flex  flex-col gap-8  mx-40  my-10 ">
            ...
            <div className="grid gap-8 grid-cols-1 sm:grid-cols-2 min-w-max ">

                <div className="flex  flex-col  justify-end  gap-4  px-8  py-8   min-h-64 min-w-64"
                ...
                <div className="grid  gap-8 grid-rows-2 ">
                    {ShopCollectionData.slice(1).map((item) =>(
                        <div key={item.id} className="flex  flex-col  justify-end  gap-4  px-8  py-8  h-64 min-w-64"
