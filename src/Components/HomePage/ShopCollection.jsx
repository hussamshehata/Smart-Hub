        ...
        <div className="flex  flex-col gap-8  mx-40  my-10 ">
            ...
            <div className="grid gap-8 grid-cols-2 ">
                ...
                style={{ backgroundImage: `url(${ShopCollectionData[0].bgImage})`, backgroundSize: 'cover', backgroundPosition: 'center' }}>
                    ...
                    <Link to={ShopCollectionData[0].link} className="text-neutral-700  inline-flex  gap-2  w-max  border-b  border-neutral-700  pb-0.5  hover:text-primary-600  hover:border-primary-600">
                        Collection 
