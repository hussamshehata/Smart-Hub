...
//                         <div className="flex flex-col justify-center px-8 py-[60px] w-1/2 bg-neutral-300">
...
//                         <div className="flex flex-col items-center w-1/3 h-[150px] bg-neutral-300 text-center p-2">
//                             <div className="py-2">
//                                 <Store size={30} />
//                             </div>
//                             <p>ADDRESS</p>
//                             <p className="pt-2 w-3/5">
...
//                             </div>
//                             <p>CONTACT US</p>
//                             <p className="pt-2">+84 234 567 890</p>
//                         </div>
...
//                             <p>EMAIL</p>
//                             <p className="pt-2">hello@3legant.com</p>
//                         </div>
//                     </div>
...
//             {/* Footer */}
//             <div className="flex justify-between bg-neutral-300 w-full py-[3rem] px-[10rem]">
//                 <div>
